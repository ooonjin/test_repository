<?php
    // $conn = mysqli_connect('192.168.0.11','water','HeK28FZG','waterdemo');   //mysql에 연결 , 진짜DB서버
    $conn = mysqli_connect('localhost', 'root', '', 'waterdb'); // 로컬 테스트용DB
?>
...
<?php
    ...
    $sql = "SELECT PRODUCT_NAME, IMAGE, FACTORY_NAME,PRICE,PRODUCT_NUMBER, AVG(VIEW_COUNT) as PRODUCT_VIEW_COUNT
    FROM PRODUCT
...
<!-- <td colspan = "8" width = "500">
            <a href="DEAILS.php?no=".$row[PRODUCT_NUMBER]><?php// echo '<img id="image_bigsize" src="data:image/jpeg;base64,'.base64_encode( $row['IMAGE'] ).'"/>';?></a>
        </td> -->